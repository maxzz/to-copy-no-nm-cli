06.15.26
TODO: maybe rename to 'copynnm' - as copy no node modules
TODO: maybe ask to create only js version since binaty is skipped by npmjs
...
TODO: If folder is lock by another application (like far) the message should be more freindly; no it was something else like shell code 120 (when failed to remove) 

DONE: If dest folder name is provided as param but does not exist then dest folder should be created
